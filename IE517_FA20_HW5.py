...
# |-|-|-|
# |Baseline|Train Acc: 0.9023 |Train Acc: 0.8920|
# |(all attributes)|Test Acc: 0.9041|Test Acc: 0.8925|
# | -|-|-|
# |PCA transform|Train Acc: 0.8672|Train Acc: 0.8625|
# |(3 PCs)|Test Acc: 0.8662|Test Acc: 0.8612|
# 
# 
# |*Experiment 1 (Treasury Yields)*|linear|SVR|
# |-|-|-|
# |Baseline|Train RMSE: 0.7767 |Train RMSE: 0.8164|
# |(all attributes)|Test RMSE: 0.7824|Test RMSE: 0.8286|
# | -|-|-|
# |PCA transform|Train RMSE: 0.9053|Train RMSE: 0.9213|
# |(3 PCs)|Test RMSE: 0.9241|Test RMSE: 0.9415|

# The Linear Regression model performs better on the untransformed data since Linear Regression has a smaller RMSE and the training time is less than the SVM model. After the PCA transformation, the cumulative explained variance ratio of the first three components is 99.44%, which means that the correlation coefficients for most variables in the datasets are high. By fitting both models, we can see that Linear Regression still performs slightly better. By looking at the training time, Linear Regression is much faster than SVM. The training times for both model imporve with PCA.
